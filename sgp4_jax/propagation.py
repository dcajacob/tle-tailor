...
"""
from math import atan2, cos, fabs, pi, sin, sqrt, copysign
#from sgp4.alpha5 import to_alpha5
from sgp4_jax.alpha5 import to_alpha5
...
#          return false, false;
     ...
     # if em < 1.0e-6:
     #     em  = 1.0e-6;
     em = jnp.max(jnp.array([em, 1.0e-6]))
...
#          ktr = ktr + 1;
     ...
     # res = minimize(kepler, jnp.asarray([eo1]), method="BFGS", tol=1.0e-12, options={'maxiter':10});
     # eo1 = res.x;
     # sineo1 = sin(eo1);
     # coseo1 = cos(eo1);
