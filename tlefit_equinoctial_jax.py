...
def test_tle_fit_normalized_equinoctial(
    ...
    for x in range(max_iter):
        ...
        while True: # Try adjusting lamda until we converge
            ...
            for offset in offsets:
                ...
                ATWA_acc += A.T @ W_scaled @ A # ER
                ATWb_acc += A.T @ W_scaled @ (b * b_scale) # ER
            ...
            if dx_limit:
                # NOTE It converges with the limits, but it's slightly worse than Equinoctial with standard COEs, without them, we beat it
    ...
    # Re-scale P?
    # FIXME: Seems like scaling blows it up. Check this.
